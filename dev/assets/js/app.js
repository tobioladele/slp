    ...
    .run(['$rootScope', '$location', '$state', '$stateParams', 'Auth',
        function ($rootScope, $location, $state, $stateParams, Auth) {
            ...
            $rootScope.$on('$stateChangeStart', function (event, toState, toParams, fromState, fromParams) {
                ...
                if (!Auth.authorize(toState.role.access)) {
                    event.preventDefault();
...
// oclazyload config
.config(['$ocLazyLoadProvider', '$urlRouterProvider', '$httpProvider', 'RestangularProvider',
    function ($ocLazyLoadProvider, $urlRouterProvider, $httpProvider, RestangularProvider) {
